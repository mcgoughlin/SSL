...
def main_worker(gpu,args):
    ...
    logdir_path = os.path.normpath(sv_str+'/'+str(cls_w)+'_'+str(patch_w)+'_'+str(rec_w)+'_'+str(args.max_epochs)+'_'+str(args.batch_size))
    ...
    for epoch in range(args.max_epochs):
        ...
        for idx, (batch_data, train_mask_all1,train_mask_all2) in enumerate(train_loader):
            ...
            if (args.rank == 0) and iter_num %100==0:
