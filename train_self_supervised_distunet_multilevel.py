...
def main_worker(gpu,args):
    ...
    logdir_path = os.path.normpath(sv_str+'/ogmask_multirecloss_'+str(args.max_epochs)+'_'+str(args.batch_size)+'_'+str(args.ngpus_per_node)+'_'+str(args.base_lr))
    ...
    for epoch in range(args.max_epochs):
        ...
        for idx, (batch_data, train_mask_all1,train_mask_all2) in enumerate(train_loader):
            ...
            for i in range(1, len(x_recs)):
                ...
                loss_unmasked = F.l1_loss(img_all_interp, x_recs[i], reduction='none').mean()
