...
def main_worker(gpu,args):
    ...
    logdir_path = os.path.normpath(sv_str+'/lowbs_test_dist_'+str(cls_w)+'_'+str(patch_w)+'_'+str(rec_w)+'_'+str(args.max_epochs)+'_'+str(args.batch_size)+'_'+str(args.ngpus_per_node))
