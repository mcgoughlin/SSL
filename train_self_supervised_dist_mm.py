...
def main_worker(gpu,args):
    ...
    logdir_path = os.path.normpath(sv_str+'/'+str(cls_w)+'_'+str(patch_w)+'_'+str(rec_w)+'_'+str(args.max_epochs)+'_'+str(args.batch_size*args.ngpus_per_node)+'_'+str(args.base_lr))
